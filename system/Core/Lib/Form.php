...
class Form
{
	 ...
	 * @return string
	 */
	public static function input($name, $value = '', $attr = [])
	{
	 ...
	 * @return string
	 */
	public static function editor($name, $value = '', $mode = 'full', $attr = [])
	{
		...
		if ($mode == 'simple') {
			...
			$options['toolbars'] = [["bold", "italic", "underline", "strikethrough", "forecolor", "backcolor", "insertorderedlist", "insertunorderedlist", "justifyleft", "justifycenter", "justifyright", "justifyjustify", "fontfamily", "fontsize"]];
		} else {
